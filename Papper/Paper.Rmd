...
```{r}
library(MASS)
res <- EM_SVM(x2,y2,alpha = 1,mu = 2,iter = 1000)
...
```{r}
library(MASS)
res2 <- ECME_SVM(x2,y2,alpha = 1,mu = 1,amu = 0.1,bmu = 0.1,iter = 1000)
...
```{r}
library(MASS)
res3 <- MCMC_SVM(x2,y2,mu = 1,iter = 1000)
decision <- Predict(x2,res2[[1]])
label <- sign(decision)
label[which(label == -1)] <- levels(y2)[2]
label[which(label == 1)] <- levels(y2)[1]
...
#EM SVM - Iris
```{r}
res <- EM_SVM(x1,y1,alpha = 1,mu = 2,iter = 1000)
...
#ECME SVM - Iris
```{r}
res2 <- ECME_SVM(x1,y1,alpha = 1,mu = 1,amu = 0.1,bmu = 0.1,iter = 1000)
