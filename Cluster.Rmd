...
plot(1:50,result,tybe="b",main="choosing the optimal number of cluster",xlab="number of cluster",ylab="betweenss/totss")
...
rect.hclust(fit.hc,k=2,border = "light grey")#浅灰色矩形框出2分类的聚类结果
```
